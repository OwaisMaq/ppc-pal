...
import { Info, ExternalLink, RefreshCw, Plus, Bug } from "lucide-react";
import { useNavigate } from "react-router-dom";
import DebugAmazonSync from "../DebugAmazonSync";
...
const NoCampaignDataAlert = ({ 
  ...
  const [showDebugTool, setShowDebugTool] = React.useState(false);
  ...
  return (
    <div className="space-y-6">
          ...
          <Alert className="border-orange-200 bg-white">
            ...
            <AlertDescription className="text-orange-800">
              {connectionCount === 0 
                ...
                : `Your Amazon connection is active (${connectionCount} connections found), but no campaign data was found. This usually means your Amazon Advertising account doesn't have any active campaigns yet, or there's a sync issue.`
              }
            </AlertDescription>
          </Alert>
            ...
            <ul className="list-disc list-inside space-y-1">
              {connectionCount === 0 ? (
                ...
                <>
                  ...
                  <li>Use the "Debug Sync Issues" button to identify connection problems</li>
                </>
              )}
            </ul>
          </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  The sync process completed successfully, but found 0 campaigns in your account. Use the debug tool below to investigate further.
                </div>
              </div>
            </div>
          )}
      ...
      {showDebugTool && connectionCount > 0 && (
        <DebugAmazonSync />
      )}
    </div>
  );
