...
const applyOptimizationsPreservingStructure = (data: AdvertisingData, suggestions: OptimizationSuggestion[]): AdvertisingData => {
...
const applyDeterministicRuleBasedOptimizationPreservingStructure = (data: AdvertisingData): AdvertisingData => {
