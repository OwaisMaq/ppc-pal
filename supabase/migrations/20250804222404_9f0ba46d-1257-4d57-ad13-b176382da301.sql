-- Enhance documentation_sources table to support different source types
...
-- Update source_type column to use enum
ALTER TABLE public.documentation_sources 
ALTER COLUMN source_type TYPE documentation_source_type USING source_type::documentation_source_type;
...
-- Insert some initial best practices for Amazon Ads API
