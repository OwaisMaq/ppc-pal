-- Drop and recreate the private.store_tokens function with correct signature
DROP FUNCTION IF EXISTS private.store_tokens(uuid,text,text,text,timestamp with time zone,text);
