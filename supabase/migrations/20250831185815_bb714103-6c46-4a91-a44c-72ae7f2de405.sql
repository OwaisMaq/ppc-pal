-- Phase 5: Dashboard views and indexes for performance data (Fixed indexes)
...
-- Performance indexes (without function-based expressions)
CREATE INDEX IF NOT EXISTS idx_fact_sp_hourly_profile_hour ON fact_sp_hourly (profile_id, hour);
CREATE INDEX IF NOT EXISTS idx_fact_sb_hourly_profile_hour ON fact_sb_hourly (profile_id, hour);
CREATE INDEX IF NOT EXISTS idx_fact_sd_hourly_profile_hour ON fact_sd_hourly (profile_id, hour);

CREATE INDEX IF NOT EXISTS idx_fact_sp_hourly_campaign_hour ON fact_sp_hourly (campaign_id, hour);
CREATE INDEX IF NOT EXISTS idx_fact_sb_hourly_campaign_hour ON fact_sb_hourly (campaign_id, hour);
CREATE INDEX IF NOT EXISTS idx_fact_sd_hourly_campaign_hour ON fact_sd_hourly (campaign_id, hour);