...
ADD COLUMN IF NOT EXISTS source_type_enum documentation_source_type DEFAULT 'manual',
...
-- Update existing rows to have the enum value
UPDATE public.documentation_sources 
SET source_type_enum = 'manual' 
