...
serve(async (req) => {
  ...
  try {
    ...
    if (!connectionId) return new Response(JSON.stringify({ error: "Missing connectionId" }), { status: 400, headers: { ...corsHeaders, "Content-Type": "application/json" } });
    ...
    async function aggregate(windowStartISO: string) {
      ...
      // Build maps for campaigns, adgroups, keywords separately
    ...
    // Fetch entity ID maps for this connection
    ...
    for (const [amazonId, a7] of seven.campAgg.entries()) {
      ...
      await supabase
        ...
        .update({
          clicks_7d: clicks7,
          impressions_7d: impressions7,
          spend_7d: spend7,
          sales_7d: sales7,
          orders_7d: orders7,
          ctr_7d: ctr7,
          cpc_7d: cpc7,
          conversion_rate_7d: cr7,
          acos_7d: acos7,
          roas_7d: roas7,
          clicks_14d: clicks14,
          impressions_14d: impressions14,
          spend_14d: spend14,
          sales_14d: sales14,
          orders_14d: orders14,
          ctr_14d: ctr14,
          cpc_14d: cpc14,
          conversion_rate_14d: cr14,
          acos_14d: acos14,
          roas_14d: roas14,
        })
        .eq("id", id);
